...
var bikeSelect = jQuery( "#input_"+gf_form_id+"_77 option:selected" ).text();
 ...
 sj_add_rider_wrapper_count = get_wrapper_count("sj_rider_wrapper");
    ...
    if (roomOccupancy != "Please select" && bikeSelect != "Select Bike") {
        jQuery('div.sj_rider_wrapper[data-rider="1"]').find( "#field_"+gf_form_id+"_152" ).append('<input type="button" id="sj_add_rider" class="gform_next_button button" value="Add Rider" tabindex="12" onclick="clone_rider_options('+sj_add_rider_wrapper_count+')"> ');
    }
});
